...
## Introduction
PhonePe has become a leader among digital payment platforms, serving millions of users for their daily transactions. 
It is known for its easy-to-use design, fast and secure payment processing, and creative features. PhonePe has gained praise and recognition in the industry. 
...
Clone the repository: `git clone https://github.com/VidhyalakshmiKK/Phonepe-Pulse-Data-Visualization-and-Exploration.git

Install the required packages

Run the Streamlit app: streamlit run phonepe_pulse_visualisation.py
...
Note : This step is performed in the .ipynb Python notebook that is in a VS code, because it is comparitively easy to visualize and tranform data in a .ipynb Python notebook as comapared to .py Python file. You can check the .ipynb notebook attached above for the code implementation of the process below.
